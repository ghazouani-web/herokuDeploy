    ...
    return (
      ...
      <section className="cards">
              <article className="card card--1">
                ...
                <a href="m" className="card_link">
                  <div className="card__img--hover" />
                </a>
                <div className="card__info">
                  <span className="card__category"> T-shirt Homme</span>
                  <h3 className="card__title">Tshirt homme couleur noir </h3>
                  <span className="card__by">by <a href="m" className="card__author" title="author">Entreprise name</a></span>
                </div>
              </article>
              <article className="card card--2">
                ...
                <div className="card__info">
                  ...
                  <span className="card__by">by <a href="m" className="card__author" title="author">Celeste Mills</a></span>
                </div>
              </article>
